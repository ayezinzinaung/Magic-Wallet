...
class AdminUserController extends Controller
{
    ...
    public function store(StoreAdminUser $request){
        ...
        return redirect()->route('admin.admin_user.index')->with('create','Successfully Created');
    }
    ...
    public function update($id, UpdateAdminUser $request){
        ...
        return redirect()->route('admin.admin_user.index')->with('create','Successfully Updated');
    }
